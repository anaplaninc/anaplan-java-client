...
ModelId="'My Model'"
Operation="-service 'https://api.anaplan.com' -auth 'https://auth.anaplan.com' -file 'My Source.txt' -chunksize 1 -put 'data/My Source.txt' -import 'My Module from My Source.txt' -execute -output 'data/My Errors.txt'"
