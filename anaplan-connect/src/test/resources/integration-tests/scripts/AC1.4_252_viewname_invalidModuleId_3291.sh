...
ModuleId="102000999010"
ViewName="Mutilple Signers Module view2"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -mo ${ModuleId} -vi '${ViewName}' -execute -get:json ${FilePath}"
