...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithPipeSepDoubleQuoDel from ListWithPipeSepDoubleQuoDel"
ExportName=""
FileName="ListWithPipeSepDoubleQuoDeli.txt"
FilePath="data/ListWithPipeSepDoubleQuoDeli.txt"
ChunkSize=1
ErrorDump="dump/ListWithPipeSepDoubleQuoDel from ListWithPipeSepDoubleQuoDel"
