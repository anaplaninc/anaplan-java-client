...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_249.json"
ModuleName="Mutilple Signers Module"
ViewId="263000000001"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -module '${ModuleName}' -view ${ViewId} -execute -get:json ${FilePath}"
