...
ExportName=""
FileName=""
FilePath="view-data/view-data-defaultview.json"
ChunkSize=1
OutputName=""
ModuleId="102000000023"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module ${ModuleId} -execute -get:json ${FilePath}"
