...
ExportName=""
FileName=""
FilePath="view-data/view-data.json"
ModuleId="Large Module for jdbc"
ViewId="default"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module '${ModuleId}' -view '${ViewId}' -execute -get:json ${FilePath}"
