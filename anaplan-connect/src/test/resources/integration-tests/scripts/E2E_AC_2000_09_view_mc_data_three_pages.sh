...
FilePath="complex-2-pages-2rows-1cols3Pages_dateAsCols2.csv"
ModuleName="complex-2-pages-2rows-1cols3Pages"
ViewName="dateAsCols2"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -mo '${ModuleName}' -vi '${ViewName}' -execute -get:csv_mc"
