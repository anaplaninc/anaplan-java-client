...
Operation="-debug -service '$ServiceUrl' -auth '$AuthUrl' -workspace 'junk' -model '${LargeModuleModelID}' -export 'PerfModule Tabular Single Column.csv' -execute -get 'export/PerfModule Tabular Single Column.csv'"
