...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithTabSepSingQuoDeliCS from ListWithTabSepSingleQuoDeli"
ExportName=""
FileName="ListWithTabSepSingleQuoDeli.csv"
FilePath="data/ListWithTabSepSingleQuoDeli.csv"
ChunkSize=1
ErrorDump="dump/ListWithTabSepSingQuoDeliCS from ListWithTabSepSingleQuoDeli"
