...
set FilePath="list-names/list-names.json"


set Operation=-debug -service %ServiceUrl% -auth %AuthUrl% -workspace %WorkspaceId% -model %ModelId%  -lists -get:json %FilePath%
