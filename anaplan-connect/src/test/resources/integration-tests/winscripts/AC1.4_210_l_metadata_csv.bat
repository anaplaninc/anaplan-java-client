...
set FilePath="list-metadata/list-metadata.csv"
set ChunkSize=1
set OutputName=""
set ListId="101000000111"

set Operation=-debug -service %ServiceUrl% -auth %AuthUrl% -workspace %WorkspaceId% -model %ModelId%  -l %ListId% -get:csv %FilePath%
