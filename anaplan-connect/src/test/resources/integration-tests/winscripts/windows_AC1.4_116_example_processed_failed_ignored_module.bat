...
set ImportName="ModuleWithProcessedIgnoredF from listWithItemsProcessedFaile"
set DumpFIle="dump\ModuleWithProcessedIgnoredF from listWithItemsProcessedFaile"
