...
set FileName="listWithItemsProcessedFailedIgnored.csv"
set FilePath="data\listWithItemsProcessedFailedIgnored.csv"
set ImportName="listWithItemsProcessedFaile from listWithItemsProcessedFaile"
set DumpFile="dump\listWithItemsProcessedFaile from listWithItemsProcessedFaile"
