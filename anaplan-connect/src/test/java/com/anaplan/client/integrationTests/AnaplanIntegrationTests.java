...
public class AnaplanIntegrationTests extends BaseIntegrationTest {
  ...
  public static Collection<AnaplanTest> data() {
    final List<String> YAML_FILES = Arrays
        .asList(
            "deleteImportExportTests.yaml",
            "basicAuthExportList.yaml",
            "BasicAuthModuleExport.yaml",
            "certAuthExportList.yaml",
            "certAuthModuleExport.yaml",
            "process.yaml",
            "miscTests.yaml",
            "deleteImportExportTestsND.yaml",
            "integraBugFixes.yaml",
            "jdbcimportexport.yaml",
            "listdata.yaml",
            "viewdatawithdimensions.yaml",
            "listviewsmodules.yaml",
            "singlecolmulticolviewdata.yaml",
            "workspacesModels.yaml"
        );
