...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithCommaSepSingleQuoDe from ListWithCommaSepSingleQuo~1"
ExportName=""
FileName="ListWithCommaSepSingleQuoDeli.txt"
FilePath="data/ListWithCommaSepSingleQuoDeli.txt"
ChunkSize=1
ErrorDump="dump/ListWithCommaSepSingleQuoDe from ListWithCommaSepSingleQuo~1"
