...
ActionName=""
ImportName="Integra-3483 from Integra-3483_PipeSep.csv"
ExportName=""
FileName="Integra-3483_PipeSep.csv"
FilePath="data/Integra-3483_PipeSep.csv"
ChunkSize=1
OutputName=""
ErrorDump="dump/Integra-3483_Tab.txt"
