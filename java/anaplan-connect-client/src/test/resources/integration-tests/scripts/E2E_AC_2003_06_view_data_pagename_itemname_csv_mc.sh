...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_06_view_data_pagename_itemname_mc.csv"
ModuleName="view-data-test"
ViewName="default"
Pages="view-data-test-dimension:a\\,b"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -mo ${ModuleName} -view ${ViewName} -pages \"${Pages}\" -execute -get:csv_mc ${FilePath}"
