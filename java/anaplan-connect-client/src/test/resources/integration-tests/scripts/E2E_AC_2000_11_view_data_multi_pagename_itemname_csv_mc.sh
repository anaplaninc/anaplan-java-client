...
FilePath="E2E_AC_2000_Test/E2E_AC_2000_11_view_data_multi_pagename_itemname_mc.csv"
ModuleId="complex-2-pages-2rows-2cols"
ViewId="631000000000"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module ${ModuleId} -view ${ViewId}  -execute -get:csv_mc ${FilePath}"
