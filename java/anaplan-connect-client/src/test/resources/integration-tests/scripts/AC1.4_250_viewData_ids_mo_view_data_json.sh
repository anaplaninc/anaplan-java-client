...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_250.json"
ModuleId="102000000010"
ViewId="263000000001"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -mo ${ModuleId} -view ${ViewId} -execute -get:json ${FilePath}"
