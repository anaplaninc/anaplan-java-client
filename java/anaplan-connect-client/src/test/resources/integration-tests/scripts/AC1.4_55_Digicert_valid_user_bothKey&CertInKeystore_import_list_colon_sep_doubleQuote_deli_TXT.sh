...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithColonSepDoubQuoDeli from ListWithColonSepDoubleQuoDe"
ExportName=""
FileName="ListWithColonSepDoubleQuoDeli.txt"
FilePath="data/ListWithColonSepDoubleQuoDeli.txt"
ChunkSize=1
ErrorDump="dump/ListWithColonSepDoubQuoDeli from ListWithColonSepDoubleQuoDe"
