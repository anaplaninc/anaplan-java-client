...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_246.json"
ModuleId="102000000010"
ViewId="263000000001"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -mo ${ModuleId} -vi ${ViewId} -execute -get:json ${FilePath}"
