...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_02_view_sc_data_2_pages.csv"
ModuleId="complex-module-2pages"
ViewId="default"
Pages="view-data-test-row1:r\ 2,view-data-test-columns:c1"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model ${ModelId} -module ${ModuleId} -vi ${ViewId} -pages '${Pages}' -execute -get:csv_sc ${FilePath}"
