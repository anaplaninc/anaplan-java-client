...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithCommaSepSingleQuoDe from ListWithCommaSepSingleQuoDe"
ExportName=""
FileName="ListWithCommaSepSingleQuoDeli.csv"
FilePath="data/ListWithCommaSepSingleQuoDeli.csv"
ChunkSize=1
ErrorDump="dump/ListWithCommaSepSingleQuoDe from ListWithCommaSepSingleQuoDe"
