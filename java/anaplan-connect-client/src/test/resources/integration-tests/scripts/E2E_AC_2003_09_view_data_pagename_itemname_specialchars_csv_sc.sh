...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_09_view_data_pagename_itemname_specialcharacters_sc.csv"
ModuleId="102000000102"
ViewId="102000000102"
Pages="view-data\\:-testlist\\,pages\\::p1\\,p4"


Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model '${ModelName}' -module ${ModuleId} -view ${ViewId} -pages \"${Pages}\" -execute -get:csv_sc ${FilePath}"
