...
ErrorDump="dump/basic-auth-Process_errors_nd"
...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${nonDefaultWorkspaceId} -model ${nonDefaultModelId} -file '${ImportDataSource1}' -put '${ImportFileName1}' -file '${ImportDataSource2}' -put '${ImportFileName2}'  -process '${ProcessName}' -execute -file '${ExportName1}' -get '${FileName1}' -file '${ExportName2}'  -get '${FileName2}' -action '${ActionName}' -execute -output '${ErrorDump}'"
