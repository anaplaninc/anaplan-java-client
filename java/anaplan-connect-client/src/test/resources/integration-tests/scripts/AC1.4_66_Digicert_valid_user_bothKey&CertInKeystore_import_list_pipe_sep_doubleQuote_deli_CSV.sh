...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithPipeSepDoubQuoDeli from ListWithPipeSepDoubleQuoDeli"
ExportName=""
FileName="ListWithPipeSepDoubleQuoDeli.csv"
FilePath="data/ListWithPipeSepDoubleQuoDeli.csv"
ChunkSize=1
ErrorDump="dump/ListWithPipeSepDoubQuoDeli from ListWithPipeSepDoubleQuoDeli"
