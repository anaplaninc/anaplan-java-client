...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_07_view_on_data_multi_pagename_itemname_sc.csv"
...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module ${ModuleId} -view ${ViewId} -pages \"${Pages1}\",\"${Pages2}\" -execute -get:csv_sc ${FilePath}"
