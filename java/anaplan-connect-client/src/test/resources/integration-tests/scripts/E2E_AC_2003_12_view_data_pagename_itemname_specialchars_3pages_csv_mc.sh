...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -module '${ModuleName}' -view '${ViewName}' -pages '${Pages}' -execute -get:csv_mc "
