...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_247.json"
ModuleId="102000000010"
ViewName="Mutilple Signers Module view2"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -mo ${ModuleId} -vi '${ViewName}' -execute -get:json ${FilePath}"
