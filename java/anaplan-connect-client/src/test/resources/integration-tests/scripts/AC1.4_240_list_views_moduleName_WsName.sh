...
ModuleName="New Hires Module"
ModuleId="102000000006"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model ${ModelId} -module '${ModuleName}' -views"
