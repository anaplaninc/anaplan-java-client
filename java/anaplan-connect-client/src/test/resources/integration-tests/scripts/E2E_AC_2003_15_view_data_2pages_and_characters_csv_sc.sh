...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_15_view_data_2pages_sc.csv"
...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model '${ModelName}' -module '${ModuleName}' -view '${ViewName}' -pages '${Pages}' -execute -get:csv_sc ${FilePath}"
