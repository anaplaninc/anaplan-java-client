...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_251.json"
ModuleName="Mutilple BOGUSNAME Module"
ViewName="Mutilple Signers odule view2"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -module '${ModuleName}' -vi '${ViewName}' -execute -get:json ${FilePath}"
