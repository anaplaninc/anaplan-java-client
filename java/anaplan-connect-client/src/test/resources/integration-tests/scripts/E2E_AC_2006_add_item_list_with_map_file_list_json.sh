...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -l ${ListId} -itemmappingproperty ${FileMapPath} -execute -putItems:json ${FilePath} "
