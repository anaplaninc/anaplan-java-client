...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -l ${ListId} -itemmappingproperty ${FileMapPath} -execute -deleteItems:json ${FilePath} "
