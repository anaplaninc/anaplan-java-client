...
ExportName=""
FileName=""
FilePath="view-data/multipleSignersViewData_244.json"
ModuleName="Mutilple Signers Module"
ViewName="Mutilple Signers Module view2"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace '${WorkspaceName}' -model '${ModelName}' -mo '${ModuleName}' -vi '${ViewName}' -execute -get:json ${FilePath}"
