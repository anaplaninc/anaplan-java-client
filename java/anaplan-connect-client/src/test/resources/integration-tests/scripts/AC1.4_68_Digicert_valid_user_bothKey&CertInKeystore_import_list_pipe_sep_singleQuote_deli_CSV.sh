...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithPipeSepSingleQuoDel from ListWithPipeSepSingleQuoDel"
ExportName=""
FileName="ListWithPipeSepSingleQuoDeli.csv"
FilePath="data/ListWithPipeSepSingleQuoDeli.csv"
ChunkSize=1
ErrorDump="dump/ListWithPipeSepSingleQuoDel from ListWithPipeSepSingleQuoDel"
