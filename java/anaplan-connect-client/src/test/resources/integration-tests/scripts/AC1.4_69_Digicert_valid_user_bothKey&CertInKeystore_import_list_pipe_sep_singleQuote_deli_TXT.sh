...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithPipeSepSingleQuoDel from ListWithPipeSepSingleQuoD~1"
ExportName=""
FileName="ListWithPipeSepSingleQuoDeli.txt"
FilePath="data/ListWithPipeSepSingleQuoDeli.txt"
ChunkSize=1
ErrorDump="dump/ListWithPipeSepSingleQuoDel from ListWithPipeSepSingleQuoD~1"
