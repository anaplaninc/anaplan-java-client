...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -export 'Grid - ListUTF16LE.csv' -execute -get 'export/imported-exported-ListUTF16LE.csv'"
