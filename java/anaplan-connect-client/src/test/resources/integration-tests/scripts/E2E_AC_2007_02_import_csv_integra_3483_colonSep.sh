...
ActionName=""
ImportName="Integra-3483 from Integra-3483_colonSep.csv"
ExportName=""
FileName="Integra-3483_colonSep.csv"
FilePath="data/Integra-3483_colonSep.csv"
ChunkSize=1
OutputName=""
ErrorDump="dump/Integra-3483_colonSep.txt"
