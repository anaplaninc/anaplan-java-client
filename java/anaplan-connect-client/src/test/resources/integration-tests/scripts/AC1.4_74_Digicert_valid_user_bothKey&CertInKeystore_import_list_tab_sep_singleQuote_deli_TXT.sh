...
CertPath=$CACertPath
ActionName=""
ImportName="ListWithTabSepSingleQuoDeli from ListWithTabSepSingleQuoDeli"
ExportName=""
FileName="ListWithTabSepSingleQuoDeli.txt"
FilePath="data/ListWithTabSepSingleQuoDeli.txt"
ChunkSize=1
ErrorDump="dump/ListWithTabSepSingleQuoDeli from ListWithTabSepSingleQuoDeli"
