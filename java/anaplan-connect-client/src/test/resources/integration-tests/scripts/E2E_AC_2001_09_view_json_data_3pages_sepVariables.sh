...
FilePath="E2E_AC_2001_Test/E2E_AC_2001_09_view_json_data_3pages_sepVariables.json"
...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module '${ModuleName}' -view '${ViewName}' -pages '${P1}','${P2}','${P3}' -execute -get:json ${FilePath}"
