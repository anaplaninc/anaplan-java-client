...
JDBCProperties=invalid-connection-jdbc.properties
ExportName="SmallList.txt"

Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -export ${ExportName} -jdbcproperties ${JDBCProperties} -execute"
