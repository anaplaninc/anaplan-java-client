...
FilePath="E2E_AC_2003_Test/E2E_AC_2003_08_view_data_multi_pagename_itemname_mc.csv"
...
Operation="-debug -service ${ServiceUrl} -auth ${AuthUrl} -workspace ${WorkspaceId} -model ${ModelId} -module ${ModuleId} -view ${ViewId} -pages \"${Pages1}\",\"${Pages2}\" -execute -get:csv_mc ${FilePath}"
