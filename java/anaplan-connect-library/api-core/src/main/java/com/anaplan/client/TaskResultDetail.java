...
public class TaskResultDetail {
  ...
  /**
   * Get the type of detail. This is useful for programmatically checking for result information.
   */
  ...
  /**
   * Get any additional information as key/value pairs. This is useful for programmatically checking for result
   * information.
   */
  ...
  /**
   * Get the localized message text. Returns a localized version of the message if available on the server, otherwise
   * the message will be in English. Any additional information is incorporated into the message.
   */
  ...
  /**
   * Get the number of occurrences. If multiple occurrences of the same detail are aggregated together in the result,
   * this contains the number of occurrences. Otherwise zero will be returned.
   */
