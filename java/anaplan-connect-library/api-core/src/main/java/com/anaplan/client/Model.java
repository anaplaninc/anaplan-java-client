...
import com.anaplan.client.exceptions.ActionsNotFoundException;
import com.anaplan.client.exceptions.AnaplanAPIException;
import com.anaplan.client.exceptions.CreateImportDatasourceError;
import com.anaplan.client.exceptions.ExportsNotFoundException;
import com.anaplan.client.exceptions.ImportsNotFoundException;
import com.anaplan.client.exceptions.ModulesNotFoundException;
import com.anaplan.client.exceptions.ProcessesNotFoundException;
import com.anaplan.client.exceptions.ServerFilesNotFoundException;
...
public class Model extends AnaplanApiClientObject {
  ...
  final ModelData getData() { return data; }
  ...
  /**
   * Get the current-workspace of the model.
   *
   * @return The identifier (GUID) for this workspace of this model.
   */
  public String getCurrentWorkspaceId() {
    return data.getCurrentWorkspaceId();
  }

  /**
   * Set the current-workspace of the model.
   *
   * @param currentWorkspaceId The identifier (GUID) for this workspace of this model.
   */
  public void setCurrentWorkspaceId(String currentWorkspaceId) {
    data.setCurrentWorkspace(currentWorkspaceId);
  }
   ...
   * @param origin An origin string to help users identify the system that created the data. This may be null.
