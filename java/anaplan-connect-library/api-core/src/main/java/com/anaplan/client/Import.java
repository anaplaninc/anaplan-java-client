...
public class Import extends TaskFactory {
  ...
  /**
   * The set of types of import definition. This enumerates possible import types available at the release of this
   * version of Anaplan Connect. It may be the case that other types have added to Anaplan in the intervening period.
   * Clients should be aware of, and handle, this potential condition gracefully.
   */
   ...
   *
   * @return the ID for the data source if it is a file; otherwise the empty string ("") is returned.
   * @since 1.2
   */
   ...
   *
   * @return The import type; null if the type is not recognized by this version of Anaplan Connect.
   * @since 1.3
   */
