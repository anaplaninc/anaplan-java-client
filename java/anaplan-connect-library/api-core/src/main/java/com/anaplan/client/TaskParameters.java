...
public class TaskParameters {
  ...
  /**
   * Default constructor. The locale is initially set to the default locale (java.util.Locale.getDefault()).
   */
   ...
   * @param parameterValue     the parameter value.
   */
  public void addConnectorParameter(SourceType sourceType, ConnectorParameter connectorParameter,
   ...
   *
   * @param sourceIdOrType     the name or ID of the data source to which this applies; or a type of data source. The
   *                           SourceType enumeration contains a list of identifiers that is complete at the time of
   *                           release of Anaplan Connect; others may be added at the server side, however.
   * @param connectorParameter a ConnectorParameter identifying the parameter to be set.
   * @param parameterValue     the parameter value.
   */
  public void addConnectorParameter(String sourceIdOrType, ConnectorParameter connectorParameter,
      String parameterValue) {
   ...
   *
   * @param sourceIdOrType the name or ID of the data source to which this applies; or a type of data source. The
   *                       SourceType enumeration contains a list of identifiers that is complete at the time of release
   *                       of Anaplan Connect; others may be added at the server side, however.
   * @param parameterId    a string identifying the parameter to be set.
   * @param parameterValue the parameter value.
   */
