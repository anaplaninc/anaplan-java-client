...
public final class Credentials {
  ...
  /**
   * Create user/passPhrase credentials for NTLM proxy authentication. This form is only used when accessing the service
  ...
  /**
   * Get the domain. This is only used when accessing the service through a proxy using the NTLM scheme.
   *
   * @since 1.3.1
   */
  ...
  /**
   * Get the workstation name. This is only used when accessing the service through a proxy using the NTLM scheme.
   *
   * @since 1.3.1
   */
